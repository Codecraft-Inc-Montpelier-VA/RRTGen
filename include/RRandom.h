// RRandom.h -- header file for a repeatable random class.
//                                             <by Cary WR Campbell>
//
...
class RRandom
{
 ...
 private:
	...
	static int Seed;	// RRandom seed value.

	static unsigned long PrevValue[ MAX_RRANDOM_IDS ];
};
